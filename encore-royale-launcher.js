(function () {
  ...
  function ensureAdminLauncher() {
    ...
    launcher.innerHTML = `<div class="encore-admin-copy"><div class="eyebrow">Installed app Â· administrator preview</div><h2>BCDKC Encore Royal</h2><p>Bypass the secret songbook pull and enter the live game room directly.</p></div><button type="button" class="btn gold encore-launch-button">Enter Encore Royal</button>`;
