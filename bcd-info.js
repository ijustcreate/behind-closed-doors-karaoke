(function () {
  ...
  function install() {
    ...
    document.head.insertAdjacentHTML('beforeend', '<style id="bcd-info-copy-scale">.bcdInfoMark,.bcdInfoAddressIcon{display:none!important}@media(max-width:520px){.bcdInfoFeature{grid-template-columns:minmax(0,1.38fr) minmax(0,1fr)!important;min-height:430px!important}.bcdInfoCopy{justify-content:center!important;gap:9px;padding:19px 14px!important}.bcdInfoCopy h3{font:500 41px/.96 Georgia,"Times New Roman",serif!important}.bcdInfoKicker{font:600 10.8px/1.36 ui-sans-serif,system-ui!important;letter-spacing:.125em!important}.bcdInfoRule{margin:8px 0 10px!important}.bcdInfoStory{max-width:100%!important;font:400 15px/1.36 Georgia,"Times New Roman",serif!important;text-align:left}.bcdInfoStory strong{font-size:1.08em}.bcdInfoAddress{padding:11px 15px!important}}</style>');
