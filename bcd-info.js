(function () {
  ...
  function install() {
    ...
    document.head.insertAdjacentHTML('beforeend', '<style id="bcd-info-mobile-blend">@media(max-width:520px){.bcdInfoFeature{overflow:hidden;min-height:330px!important}.bcdInfoCopy{position:relative;z-index:2;display:flex;flex-direction:column;align-items:center;padding:9px 12px 10px!important;text-align:center;background:linear-gradient(90deg,#2b1210 0%,#25100f 72%,rgba(37,16,15,.1) 100%)}.bcdInfoMark{margin:0 auto 3px!important}.bcdInfoRule{width:100%;margin:7px 0 8px!important}.bcdInfoScene{position:relative;z-index:1;margin-left:-42px!important;padding-left:42px;background-position:center!important;mask-image:linear-gradient(90deg,transparent 0%,rgba(0,0,0,.48) 40%,#000 100%)!important;-webkit-mask-image:linear-gradient(90deg,transparent 0%,rgba(0,0,0,.48) 40%,#000 100%)!important}.bcdInfoCopy h3{font-size:31px;line-height:1.02}.bcdInfoKicker{font-size:9px!important;line-height:1.35!important}.bcdInfoStory{max-width:100%;font-size:11.2px!important;line-height:1.34!important}}</style>');
