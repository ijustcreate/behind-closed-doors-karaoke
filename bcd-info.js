(function () {
  ...
  function install() {
    ...
    document.head.insertAdjacentHTML('beforeend', '<style id="bcd-info-mobile-blend">@media(max-width:520px){.bcdInfoFeature{overflow:hidden}.bcdInfoCopy{position:relative;z-index:2;background:linear-gradient(90deg,#2b1210 0%,#25100f 72%,rgba(37,16,15,.1) 100%)}.bcdInfoScene{position:relative;z-index:1;margin-left:-42px!important;padding-left:42px;background-position:center!important;mask-image:linear-gradient(90deg,transparent 0%,rgba(0,0,0,.48) 40%,#000 100%)!important;-webkit-mask-image:linear-gradient(90deg,transparent 0%,rgba(0,0,0,.48) 40%,#000 100%)!important}.bcdInfoCopy h3{font-size:28px}.bcdInfoKicker{font-size:8px!important;line-height:1.4!important}.bcdInfoStory{font-size:10.2px!important;line-height:1.4!important}}</style>');
