(function () {
  ...
  function install() {
    ...
    document.head.insertAdjacentHTML('beforeend', '<style id="bcd-info-mobile-blend">@media(max-width:520px){.bcdInfoFeature{overflow:hidden;min-height:345px!important}.bcdInfoCopy{position:relative;z-index:2;display:flex;flex-direction:column;align-items:center;padding:9px 10px 10px!important;text-align:center;background:linear-gradient(90deg,#2b1210 0%,#25100f 72%,rgba(37,16,15,.1) 100%)}.bcdInfoMark{margin:0 auto 3px!important}.bcdInfoRule{width:100%;margin:7px 0 8px!important}.bcdInfoScene{position:relative;z-index:1;margin-left:-42px!important;padding-left:42px;background-position:center!important;mask-image:linear-gradient(90deg,transparent 0%,rgba(0,0,0,.48) 40%,#000 100%)!important;-webkit-mask-image:linear-gradient(90deg,transparent 0%,rgba(0,0,0,.48) 40%,#000 100%)!important}.bcdInfoCopy h3{font:500 33px/1.02 Georgia,"Times New Roman",serif}.bcdInfoKicker{font:600 9.6px/1.35 ui-sans-serif,system-ui!important}.bcdInfoStory{align-self:center;max-width:96%;font:400 11.8px/1.36 Georgia,"Times New Roman",serif!important;letter-spacing:0!important;text-align:left;text-transform:none!important}.bcdInfoStory .bcdInfoLine,.bcdInfoStory strong{font-family:Georgia,"Times New Roman",serif!important;text-transform:none!important}.bcdInfoStory strong{font-weight:600!important}}</style>');
