(function () {
  ...
  function install() {
    document.head.insertAdjacentHTML('beforeend', `<style id="bcd-info-styles">
      ...
      .bcdHours{margin:0 0 15px;padding:14px 0 13px;border-bottom:1px solid rgba(201,162,87,.17)}.bcdHoursTitle{margin-bottom:8px;color:#cfa75e;font-size:10px;letter-spacing:.16em;text-align:center;text-transform:uppercase}.bcdHoursGrid{display:grid;grid-template-columns:repeat(2,minmax(0,1fr));gap:0 18px;color:#cdbb9c;font-size:12px;line-height:1.45}.bcdHoursColumn{display:grid;grid-template-columns:auto 1fr;gap:4px 10px;align-content:start}.bcdHoursColumn+ .bcdHoursColumn{padding-left:18px;border-left:1px solid rgba(201,162,87,.2)}.bcdHoursGrid dt{font-weight:700;color:#f0dfbd}.bcdHoursGrid dd{margin:0;text-align:right}.bcdHoursGrid .closed{color:#927b61}
