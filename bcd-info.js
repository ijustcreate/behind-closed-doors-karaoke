(function () {
  ...
  function install() {
    ...
    document.head.insertAdjacentHTML('beforeend', '<style id="bcd-info-copy-scale">.bcdInfoMark,.bcdInfoAddressIcon{display:none!important}@media(max-width:520px){.bcdInfoFeature{grid-template-columns:minmax(0,1.12fr) minmax(0,.88fr)!important;min-height:360px!important}.bcdInfoCopy{align-self:center!important;justify-content:center!important;gap:8px;padding:18px!important}.bcdInfoCopy h3{font:500 38px/1.02 Georgia,"Times New Roman",serif!important}.bcdInfoKicker{font:600 10.5px/1.38 ui-sans-serif,system-ui!important;letter-spacing:.13em!important}.bcdInfoRule{margin:2px 0!important}.bcdInfoStory{max-width:100%!important;font:400 13.2px/1.4 Georgia,"Times New Roman",serif!important;text-align:left}.bcdInfoStory strong{font-size:1.06em}.bcdInfoScene{margin-left:-70px!important;padding-left:70px!important;background-position:25% center!important;mask-image:linear-gradient(90deg,transparent 0%,rgba(0,0,0,.38) 30%,#000 67%)!important;-webkit-mask-image:linear-gradient(90deg,transparent 0%,rgba(0,0,0,.38) 30%,#000 67%)!important}.bcdInfoAddress{padding:11px 15px!important}}</style>');
