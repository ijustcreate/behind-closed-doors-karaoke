(function () {
  ...
  function install() {
    ...
    document.head.insertAdjacentHTML('beforeend', '<style id="bcd-info-copy-scale">.bcdInfoMark,.bcdInfoAddressIcon{display:none!important}@media(max-width:520px){.bcdInfoFeature{min-height:430px!important}.bcdInfoCopy{justify-content:center!important;gap:11px;padding:19px 15px!important}.bcdInfoCopy h3{font:500 45px/.94 Georgia,"Times New Roman",serif!important}.bcdInfoKicker{font:600 11.5px/1.38 ui-sans-serif,system-ui!important;letter-spacing:.13em!important}.bcdInfoRule{margin:8px 0 10px!important}.bcdInfoStory{max-width:100%!important;font:400 15px/1.36 Georgia,"Times New Roman",serif!important}.bcdInfoStory strong{font-size:1.08em}.bcdInfoAddress{padding:11px 15px!important}}</style>');
